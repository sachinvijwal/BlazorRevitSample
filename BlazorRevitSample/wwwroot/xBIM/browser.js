...
$(document).ready(function () {
    ...
    $("#btnZoom").click(function () {
        //viewer.zoomTo(parseInt($("#IFCId").val()));

        viewer.resetStates();
        viewer.renderingMode = "x-ray";
        //viewer.renderingMode = "normal";
        var id = parseInt($("#IFCId").val());
    ...
    if (check.noErrors) {
        ...
        viewer.load("/xBIM/WexBIM/Rettorato.wexbim");
        browser.load("/xBIM/WexBIM/Rettorato.json");

        //viewer.load("/WexBIM/SampleHouse.wexbim");
        //browser.load("/WexBIM/SampleHouse.json");

        //viewer.load("/WexBIM/Sample.wexbim");
        //browser.load("/WexBIM/Sample.json");
